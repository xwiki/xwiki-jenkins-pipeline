 ...
 * <p>
 *
 * @param branch the branch to build on (e.g. "stable-10.10.x"). If not specified then we assume it's "master"
 */
def getLatestConfigurations(def branch)
{
    def configurations = [
 ...
 *
 * @param branch the branch to build on (e.g. "master", "stable-10.10.x")
 */
def getAllConfigurations(def branch)
{
    def configurations = [
 ...
 * @param branch the branch to build on (e.g. "master", "stable-10.10.x")
 */
def getUnsupportedConfigurations(def branch)
{
    def configurations = [
