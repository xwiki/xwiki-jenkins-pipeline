...
def call(String name = 'Default', body)
{
    ...
    stage("Post Build for ${name}") {
        ...
        archiveArtifacts artifacts: "${workspace}/**/target/*/*.flv", allowEmptyArchive: true

        // Save images generated by functional tests, if any
        archiveArtifacts artifacts: "${workspace}/**/target/screenshots/*.png", allowEmptyArchive: true
